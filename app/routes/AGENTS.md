...
/app                       → app.tsx (layout: auth + shop data + onboarding)
  ...
  /onboarding              → app.onboarding.tsx (6-step wizard)
...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `app.tsx`              | `shopInfo`, `doesThemeSupportBlock`, `fetchAllOnboardingData`                                                                                                                                 |
...
| `app.settings.webhook` | `shopInfo`, `frakWebhookStatus`, `getWebhooks`, `createWebhook`, `deleteWebhook`                                                                                                              |
...
- **No `useSubmit()`**: All form submissions go through `useFetcher()` in child components.
...
- **No `redirect` from `@remix-run/node`** — use redirect from `authenticate.admin`. Embedded app loses session.
